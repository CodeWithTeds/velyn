...
import { Food1Poster, food1, Food2Poster, food2, Food3Poster, food3, Food4Poster, food4, Food5Poster, food5 } from '@/components/templates/food';
              ...
              {template.kind === 'portrait-poster' || template.kind === 'food-poster' ? (
                <div className="bg-transparent p-0">
                  {template.id === 0 ? (
                    ...
                    <Food3Poster imageSrc={template.image} compact className="mx-auto max-h-80" />
                  ) : template.id === 14 ? (
                    <Food4Poster imageSrc={template.image} compact className="mx-auto max-h-80" />
                  ) : template.id === 15 ? (
                    <Food5Poster imageRightSrc={template.image} compact className="mx-auto max-h-80" />
                  ) : null}
                </div>
              ) : (
                <img
